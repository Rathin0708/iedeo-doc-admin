                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: _isFirstAdmin ? Colors.green[50] : Colors
                            .orange[50],
                        borderRadius: BorderRadius.circular(8),
                        border: Border.all(
                          color: _isFirstAdmin ? Colors.green[200]! : Colors
                              .orange[200]!,
                        ),
                      ),
                      child: Row(
                        children: [
                          Icon(
                            _isFirstAdmin ? Icons.security : Icons.info_outline,
                            color: _isFirstAdmin ? Colors.green[600] : Colors
                                .orange[600],
                          ),
                          ...
                          Expanded(
                            child: Text(
                              _isFirstAdmin
                                  ? 'This will be the first admin account with full system access.'
                                  : 'Admin accounts are stored separately from doctors and therapists in Firebase.',
                              style: TextStyle(
                                fontSize: 12,
                                color: _isFirstAdmin
                                    ? Colors.green[800]
